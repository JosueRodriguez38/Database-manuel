...
class SupplierDAO:
    ...
    # Displays all the suppliers in the city whose name was received as input
    ...
    # Allows for the change of the name, city and phone number of the supplier whose id matches the input,
    # if it exists
