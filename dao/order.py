...
class OrderDAO:
    ...
    def getAllOrders(self):
        ...
        query = "select userid, firstname, lastname, orderid, ammountordered, dateOrdered, resourceTypeName, purchaseTypeName from order natural inner join order_resource natural inner join Resources natural inner join Resource_Types natural inner join users natural inner join Purchase_Type order by resourcetypename;"
    ...
    def getAllOrdersByResourceName(self, resourceTypeNumber):
        cursor = self.conn.cursor()
        query = "select userid, firstname, lastname, orderid, ammountordered, dateOrdered, resourceTypeName, purchaseTypeName from order natural inner join order_resource natural inner join Resources natural inner join Resource_Types natural inner join Purchase_Type where resourceTypeNumber = %s;"
    ...
    def getAllOrdersByPurchaseType(self, purchaseTypeNumber):
        cursor = self.conn.cursor()
        query = "select userid, firstname, lastname, orderid, ammountordered, dateOrdered, resourceTypeName, purchaseTypeName from order natural inner join order_resource natural inner join Resources natural inner join Resource_Types natural inner join Purchase_Type where PurchaseTypeNumber = %s order by resourcetypename;"
    ...
    def getAllOrdersByDate(self, dateOrdered):
        cursor = self.conn.cursor()
        query = "select userid, firstname, lastname, orderid, ammountordered, dateOrdered, resourceTypeName, purchaseTypeName from order natural inner join order_resource natural inner join Resources natural inner join Resource_Types natural inner join Purchase_Type where dateOrdered = %s order by resourcetypename;"
    ...
    def getAllOrdersByResourceNameAndUserID(self, resourceTypeNumber, userid):
        cursor = self.conn.cursor()
        query = "select userid, firstname, lastname, orderid, ammountordered, dateOrdered, resourceTypeName, purchaseTypeName from order natural inner join order_resource natural inner join Resources natural inner join Resource_Types natural inner join Purchase_Type where resourceTypeNumber = %s and userid = %s;"
